...
import { patients, providers } from '../page'
...
import {CardContent, TextField, Box, Dialog, Select, IconButton, Snackbar, Alert, CircularProgress, MenuItem } from '@mui/material';
        ...
        >
            <form 
                ...
                action={(formData) => {
                    ...
                    formData.append("provider_id", sender.id)
                    sendEmail(formData)
                }}
            >
                    ...
                    <span className="sender-receiver-field">
                        ...
                        >
                            {patients.map((patient, index) => 
                                <MenuItem key={index} value={patient.id}>{patient.fullName}</MenuItem>
                            )}
                        </Select>
                    </span>
                    <span className="sender-receiver-field">
